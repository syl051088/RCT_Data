...
analyze_rct = function(df,
  ...
  sl_res = analyze_rct_sl(
    ...
    reference_arm = control_level,   # so SL knows which arm is “Control”
    K             = K,               # you can expose this in your wrapper’s args
    SL_methods    = SL_methods,      # same for SL_methods
    n_cores       = n_cores,
    seed          = seed
  )
...
resutls = analyze_rct(df1_ys, outcome)
