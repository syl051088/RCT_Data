...
prepare_long_data = function(data) {
  data %>%
    ...
    mutate(method = dplyr::case_match(
      ...
      "precision_gain_Logistic_G_Computation"       ~ "Logistic G-computation",
      ...
      "precision_gain_Logistic_G_Computation_VS1"   ~ "Logistic G-computation_VS1",
      ...
      "precision_gain_Logistic_G_Computation_VS2"   ~ "Logistic G-computation_VS2",
...
###############################################################################
build_and_print_table = function(outcome_type, vs_type = "none", data_type = "all") {
  ...
  if (outcome_type == "continuous") {
    logistic_methods = if (vs_type == "none") {
      ...
      "Logistic G-computation_VS1"
    } else if (vs_type == "VS2") {
      "Logistic G-computation_VS2"
    }
  ...
  cat("\n========================================\n")
  cat(paste0(stringr::str_to_title(outcome_type), " Outcomes - ", vs_label, 
...
make_plot = function(data, outcome_type) {
  ...
  if (outcome_type == "binary") {
    # Define custom order: Logistic G-computation before DML
...
build_and_print_table("binary", vs_type = "none", data_type = "all")

p_binary_base_all = make_plot(df_binary_base_all, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_base_all.png", 
       p_binary_base_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - All outcomes
df_binary_vs1_all = df_long_outlier_removed_all %>% 
  filter(outcome_group == "binary", grepl("_VS1$", method))
build_and_print_table("binary", vs_type = "VS1", data_type = "all")

p_binary_vs1_all = make_plot(df_binary_vs1_all, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_vs1_all.png", 
       p_binary_vs1_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - All outcomes
df_binary_vs2_all = df_long_outlier_removed_all %>% 
  filter(outcome_group == "binary", grepl("_VS2$", method))
build_and_print_table("binary", vs_type = "VS2", data_type = "all")

p_binary_vs2_all = make_plot(df_binary_vs2_all, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_vs2_all.png", 
       p_binary_vs2_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")
...
build_and_print_table("continuous", vs_type = "none", data_type = "all")

p_cont_base_all = make_plot(df_continuous_base_all, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_base_all.png", 
       p_cont_base_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

df_continuous_vs1_all = df_long_outlier_removed_all %>% 
  filter(outcome_group == "continuous", grepl("_VS1$", method))
build_and_print_table("continuous", vs_type = "VS1", data_type = "all")

p_cont_vs1_all = make_plot(df_continuous_vs1_all, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_vs1_all.png", 
       p_cont_vs1_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

df_continuous_vs2_all = df_long_outlier_removed_all %>% 
  filter(outcome_group == "continuous", grepl("_VS2$", method))
build_and_print_table("continuous", vs_type = "VS2", data_type = "all")

p_cont_vs2_all = make_plot(df_continuous_vs2_all, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_vs2_all.png", 
       p_cont_vs2_all, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")
...
df_binary_base_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "binary", !grepl("_VS[12]$", method))
build_and_print_table("binary", vs_type = "none", data_type = "primary")

p_binary_base_primary = make_plot(df_binary_base_primary, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_base_primary.png", 
       p_binary_base_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - Primary outcomes
df_binary_vs1_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "binary", grepl("_VS1$", method))
build_and_print_table("binary", vs_type = "VS1", data_type = "primary")

p_binary_vs1_primary = make_plot(df_binary_vs1_primary, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_vs1_primary.png", 
       p_binary_vs1_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - Primary outcomes
df_binary_vs2_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "binary", grepl("_VS2$", method))
build_and_print_table("binary", vs_type = "VS2", data_type = "primary")

p_binary_vs2_primary = make_plot(df_binary_vs2_primary, "binary")
ggsave("cleaned_data/Plot/precision_gain_binary_vs2_primary.png", 
       p_binary_vs2_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# Continuous plots - Primary outcomes
df_continuous_base_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "continuous", !grepl("_VS[12]$", method))
build_and_print_table("continuous", vs_type = "none", data_type = "primary")

p_cont_base_primary = make_plot(df_continuous_base_primary, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_base_primary.png", 
       p_cont_base_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

df_continuous_vs1_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "continuous", grepl("_VS1$", method))
build_and_print_table("continuous", vs_type = "VS1", data_type = "primary")

p_cont_vs1_primary = make_plot(df_continuous_vs1_primary, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_vs1_primary.png", 
       p_cont_vs1_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

df_continuous_vs2_primary = df_long_outlier_removed_primary %>% 
  filter(outcome_group == "continuous", grepl("_VS2$", method))
build_and_print_table("continuous", vs_type = "VS2", data_type = "primary")

p_cont_vs2_primary = make_plot(df_continuous_vs2_primary, "continuous")
ggsave("cleaned_data/Plot/precision_gain_continuous_vs2_primary.png", 
       p_cont_vs2_primary, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")
...
print(p_binary_base_all)
print(p_binary_vs1_all)
print(p_binary_vs2_all)
print(p_cont_base_all)
print(p_cont_vs1_all)
print(p_cont_vs2_all)

cat("\nPrimary Outcomes Plots:\n")
print(p_binary_base_primary)
print(p_binary_vs1_primary)
print(p_binary_vs2_primary)
print(p_cont_base_primary)
print(p_cont_vs1_primary)
print(p_cont_vs2_primary)
```
# N vs Var Ratio Plot
```{r}
###############################################################################
##  6.  Sample Size vs Variance Ratio Plots ----------------------------------
###############################################################################

# Function to create sample size vs variance ratio plot with smoothed curves
make_sample_size_plot = function(data, outcome_type) {
  
  # Set factor levels for binary outcomes to control order (same as violin plots)
  if (outcome_type == "binary") {
    method_levels = c("ANCOVA", "ANHECOVA", "Logistic G-computation", "DML", "TMLE",
                     "ANCOVA_VS1", "ANHECOVA_VS1", "Logistic G-computation_VS1", "DML_VS1", "TMLE_VS1",
                     "ANCOVA_VS2", "ANHECOVA_VS2", "Logistic G-computation_VS2", "DML_VS2", "TMLE_VS2")
...
# First, add Sample_Size to the long data
# Merge Sample_Size from df_new to long datasets
df_long_with_size_all = df_long_full_all %>%
  left_join(df_new %>% select(outcome_group, Sample_Size), 
            by = "outcome_group", relationship = "many-to-many")

df_long_with_size_primary = df_long_full_primary %>%
  left_join(df_new_primary %>% select(outcome_group, Sample_Size), 
            by = "outcome_group", relationship = "many-to-many")
...
###############################################################################
##  7.  Generate all sample size plots (All outcomes) ------------------------
###############################################################################

# Base methods (no VS) - All outcomes - Binary
df_binary_base_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "binary", !grepl("_VS[12]$", method))

p_binary_base_all_size = make_sample_size_plot(df_binary_base_all_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_base_all.png", 
       p_binary_base_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - All outcomes - Binary
df_binary_vs1_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "binary", grepl("_VS1$", method))

p_binary_vs1_all_size = make_sample_size_plot(df_binary_vs1_all_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_vs1_all.png", 
       p_binary_vs1_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - All outcomes - Binary
df_binary_vs2_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "binary", grepl("_VS2$", method))

p_binary_vs2_all_size = make_sample_size_plot(df_binary_vs2_all_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_vs2_all.png", 
       p_binary_vs2_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# Base methods - All outcomes - Continuous
df_continuous_base_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "continuous", !grepl("_VS[12]$", method))

p_cont_base_all_size = make_sample_size_plot(df_continuous_base_all_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_base_all.png", 
       p_cont_base_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - All outcomes - Continuous
df_continuous_vs1_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "continuous", grepl("_VS1$", method))

p_cont_vs1_all_size = make_sample_size_plot(df_continuous_vs1_all_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_vs1_all.png", 
       p_cont_vs1_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - All outcomes - Continuous
df_continuous_vs2_all_size = df_long_size_cleaned_all %>% 
  filter(outcome_group == "continuous", grepl("_VS2$", method))

p_cont_vs2_all_size = make_sample_size_plot(df_continuous_vs2_all_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_vs2_all.png", 
       p_cont_vs2_all_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

###############################################################################
##  8.  Generate all sample size plots (Primary outcomes) --------------------
###############################################################################

# Base methods (no VS) - Primary outcomes - Binary
df_binary_base_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "binary", !grepl("_VS[12]$", method))

p_binary_base_primary_size = make_sample_size_plot(df_binary_base_primary_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_base_primary.png", 
       p_binary_base_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - Primary outcomes - Binary
df_binary_vs1_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "binary", grepl("_VS1$", method))

p_binary_vs1_primary_size = make_sample_size_plot(df_binary_vs1_primary_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_vs1_primary.png", 
       p_binary_vs1_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - Primary outcomes - Binary
df_binary_vs2_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "binary", grepl("_VS2$", method))

p_binary_vs2_primary_size = make_sample_size_plot(df_binary_vs2_primary_size, "binary")
ggsave("cleaned_data/Plot/samplesize_binary_vs2_primary.png", 
       p_binary_vs2_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# Base methods - Primary outcomes - Continuous
df_continuous_base_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "continuous", !grepl("_VS[12]$", method))

p_cont_base_primary_size = make_sample_size_plot(df_continuous_base_primary_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_base_primary.png", 
       p_cont_base_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS1 methods - Primary outcomes - Continuous
df_continuous_vs1_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "continuous", grepl("_VS1$", method))

p_cont_vs1_primary_size = make_sample_size_plot(df_continuous_vs1_primary_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_vs1_primary.png", 
       p_cont_vs1_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# VS2 methods - Primary outcomes - Continuous
df_continuous_vs2_primary_size = df_long_size_cleaned_primary %>% 
  filter(outcome_group == "continuous", grepl("_VS2$", method))

p_cont_vs2_primary_size = make_sample_size_plot(df_continuous_vs2_primary_size, "continuous")
ggsave("cleaned_data/Plot/samplesize_continuous_vs2_primary.png", 
       p_cont_vs2_primary_size, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")

# Display all 12 sample size plots
cat("\n========================================\n")
cat("All sample size plots saved at publication quality (600 dpi, white background)\n")
cat("========================================\n\n")

cat("All Outcomes - Sample Size Plots:\n")
print(p_binary_base_all_size)
print(p_binary_vs1_all_size)
print(p_binary_vs2_all_size)
print(p_cont_base_all_size)
print(p_cont_vs1_all_size)
print(p_cont_vs2_all_size)

cat("\nPrimary Outcomes - Sample Size Plots:\n")
print(p_binary_base_primary_size)
print(p_binary_vs1_primary_size)
print(p_binary_vs2_primary_size)
print(p_cont_base_primary_size)
print(p_cont_vs1_primary_size)
print(p_cont_vs2_primary_size)
```

```{r}
###############################################################################
##  6.  Sample Size vs Variance Ratio Plots (GAM + Progress) ----------------
###############################################################################
...
# Function with GAM smoothing (much faster than loess)
make_sample_size_plot = function(data, outcome_type) {
...
# Create a data frame with all plot configurations
plot_configs = tibble::tribble(
  ~plot_name,                              ~data_source,    ~outcome_type,  ~vs_type,
  "samplesize_binary_base_all",            "all",           "binary",       "base",
  "samplesize_binary_vs1_all",             "all",           "binary",       "vs1",
  "samplesize_binary_vs2_all",             "all",           "binary",       "vs2",
  "samplesize_continuous_base_all",        "all",           "continuous",   "base",
  "samplesize_continuous_vs1_all",         "all",           "continuous",   "vs1",
  "samplesize_continuous_vs2_all",         "all",           "continuous",   "vs2",
  "samplesize_binary_base_primary",        "primary",       "binary",       "base",
  "samplesize_binary_vs1_primary",         "primary",       "binary",       "vs1",
  "samplesize_binary_vs2_primary",         "primary",       "binary",       "vs2",
  "samplesize_continuous_base_primary",    "primary",       "continuous",   "base",
  "samplesize_continuous_vs1_primary",     "primary",       "continuous",   "vs1",
  "samplesize_continuous_vs2_primary",     "primary",       "continuous",   "vs2"
)

# Function to generate and save a single plot
generate_plot = function(plot_name, data_source, outcome_type, vs_type) {
  ...
  # Create plot
  p = make_sample_size_plot(df_filtered, outcome_type)
  
  # Save plot
  ggsave(paste0("cleaned_data/Plot/", plot_name, ".png"), 
         p, width = pub_width, height = pub_height, dpi = pub_dpi, bg = "white")
  
  return(list(plot_name = plot_name, plot = p))
}

# Generate all plots in parallel with progress bar
cat("\n========================================\n")
cat("Generating 12 sample size plots in parallel using GAM smoothing...\n")
...
# Extract plots from results for display
plots_list = setNames(lapply(results, function(x) x$plot), 
                      sapply(results, function(x) x$plot_name))

cat("All Outcomes - Sample Size Plots:\n")
print(plots_list$samplesize_binary_base_all)
print(plots_list$samplesize_binary_vs1_all)
print(plots_list$samplesize_binary_vs2_all)
print(plots_list$samplesize_continuous_base_all)
print(plots_list$samplesize_continuous_vs1_all)
print(plots_list$samplesize_continuous_vs2_all)

cat("\nPrimary Outcomes - Sample Size Plots:\n")
print(plots_list$samplesize_binary_base_primary)
print(plots_list$samplesize_binary_vs1_primary)
print(plots_list$samplesize_binary_vs2_primary)
print(plots_list$samplesize_continuous_base_primary)
print(plots_list$samplesize_continuous_vs1_primary)
print(plots_list$samplesize_continuous_vs2_primary)
...
plot_configs = tibble::tibble(
  ...
  vs_type = rep(rep(c("base", "vs1", "vs2", "base", "vs1", "vs2"), 2), 3),
...
cat("\n========================================\n")
cat("To save a specific plot, use:\n")
cat("ggsave('filename.png', results[[INDEX]]$plot, width=8, height=6, dpi=600, bg='white')\n")
cat("========================================\n")
```
...
print(p)
ggsave("cleaned_data/Plot/sample_size_linear.png", p, width = 10, height = 6, dpi = 300)
...
df_binned = df %>%
  mutate(
    size_category = cut(sample_size, 
                       breaks = c(0, 100, 250, 500, 1000, 2000, Inf),
                       labels = c("0-100", "100-250", "250-500", 
...
p_custom = ggplot(df_binned, aes(x = size_category)) +
  ...
  labs(title = "Distribution of Sample Sizes (Custom Bins)",
       subtitle = paste0("Analysis of ", n_studies, " studies - grouped by size range"),
       x = "Sample Size Range",
       y = "Number of Studies",
       caption = paste0("Mean: ", round(mean_size, 0), 
                       " | Median: ", round(median_size, 0))) +
...
print(p_custom)
ggsave("cleaned_data/Plot/sample_size_custom_bins.png", p_custom, width = 10, height = 6, dpi = 300)
...
p_sqrt = ggplot(df, aes(x = sqrt(sample_size))) +
  ...
  labs(title = "Distribution of Sample Sizes (Square Root Scale)",
       subtitle = "Square root transformation to better visualize skewed distribution",
       x = "Sample Size (√ scale)",
       y = "Frequency",
       caption = paste0("Mean: ", round(mean_size, 0), 
                       " | Median: ", round(median_size, 0))) +
...
print(p_sqrt)
ggsave("cleaned_data/Plot/sample_size_sqrt.png", p_sqrt, width = 10, height = 6, dpi = 300)
...
print(p_log)
ggsave("cleaned_data/Plot/sample_size_log.png", p_log, width = 10, height = 6, dpi = 300)
...
p2 <- ggplot(area_counts, 
  ...
  labs(
    title = "Distribution of Research Areas (N=50)",
    fill = "Research Area"
  ) +
...
# Display and save
print(p2)
ggsave("cleaned_data/Plot/research_area_pie.png", p2, width = 12, height = 7, dpi = 300)
...
rand_colors <- c(
  "Stratified Block" = "#E41A1C",
  "Simple" = "#377EB8", 
  "Block" = "#4DAF4A",
  "Stratified" = "#984EA3",
  "Cluster" = "#FF7F00",
  "Covariate Adaptive" = "#FFFF33"
)
...
p1 <- ggplot(randomization_counts, 
  ...
  labs(
    title = "Distribution of Randomization Schemes (N=50)",
    fill = "Randomization Scheme"
  ) +
...
# Display and save
print(p1)
ggsave("cleaned_data/Plot/randomization_scheme_pie.png", p1, width = 10, height = 6, dpi = 300)
