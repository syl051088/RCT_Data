...
df_comparison = update_df(12, rep("continuous", n))
```
...
df_comparison = update_df(13, rep("continuous", n))
```
...
df_comparison = update_df(14, rep("continuous", n))
```
...
df_comparison = update_df(18, rep("continuous", n))
```
...
df_comparison = update_df(19, rep("continuous", n))
```
...
df_comparison = update_df(21, rep("continuous", n))
```
...
df_comparison = update_df(23, rep("continuous", n))
```
...
df_comparison = update_df(24, rep("continuous", n))
```
...
df_comparison = update_df(25, rep("continuous", n))
```
...
df_comparison = update_df(26, rep("continuous", n))
```
...
df_comparison = update_df(27, rep("continuous", n))
```
