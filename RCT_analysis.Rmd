...
df_long_outlier_removed = df_outlier_removed %>%
  select(outcome_group, sample_size_cat, 
         ...
         precision_gain_SL_gam_VS2, precision_gain_SL_bartMachine_VS2, precision_gain_SL2_VS2, precision_gain_TMLE_VS2) %>%  # ADDED TMLE_VS2
  ...
  mutate(
    ...
    method = factor(method, levels = c(
      ...
      "SL_randomForest_VS2", "SL_glmnet_VS2", "SL_gam_VS2", "SL_bartMachine_VS2", "SL2_VS2", "TMLE_VS2"))  # ADDED SL_glmnet_VS2 and TMLE_VS2
  )
...
method_colors = c(
  ...
  "SL_gam_VS2" = "#9c9ede", "SL_bartMachine_VS2" = "#637939", "SL2_VS2" = "#8ca252", "TMLE_VS2" = "#de9ed6"  # ADDED COLOR FOR TMLE_VS2
)
...
df_long_full = df_new %>%       # df_new in your workspace
  ...
  mutate(method = dplyr::case_match(
    ...
    "precision_gain_SL_glmnet_VS2"           ~ "SL_glmnet_VS2",
    "precision_gain_TMLE_VS2"                ~ "TMLE_VS2"  # ADDED THIS LINE
  ))
