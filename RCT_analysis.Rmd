...
analyze_rct = function(df,
  ...
  sl_res = analyze_rct_sl(
    ...
    # so SL knows which arm is “Control”
    K             = K,
    # you can expose this in your wrapper’s args
...
results = analyze_rct(df7_yp, outcome)

df_comparison = update(7, results, rep("coutninuous", length(outcome)))
```
...
df_comparison = update(18, results, rep("countinuous", length(outcome)))
```
...
df_comparison = update(19, results, "countinuous")
```
...
df_comparison = update(20, results, "countinuous")
```
...
df_comparison = update(20, analyze_rct(df20_ys, outcome), rep("continous", length(outcome)))
```
