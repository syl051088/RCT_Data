...
fit1$contrast$result
se1.1_rob = as.numeric(round(fit1$contrast$result[1,3], 3))

se1.2_rob = as.numeric(round(fit1$contrast$result[2,3], 3))
```
...
# Create formula string
form_str = paste("YP_RTPCR_negative_6d ~ Treatment + ", paste(covariates, collapse = " + "))
```
