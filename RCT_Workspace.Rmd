...
col_names = c(
  # ── Metadata ────────────────────────────────────────────────────────────
  "Trial_No", "Sample_Size", "N_Covariates", "Treatment", "Control",
  "Contrast", "Outcome", "Outcome Type",

  # ── Standard errors ─────────────────────────────────────────────────────
  "Unadjust_se",
  "ANCOVA_robust_se",  "ANCOVA_model_based_se",  "ANHECOVA_robust_se",
  "Binom_robust_se",   "SL_se",  "SL_rpart_se",  "SL_ranger_se",  "SL_nnet_se",
  "ANCOVA_VS_robust_se",  "ANCOVA_VS_model_based_se",  "ANHECOVA_VS_robust_se",
  "Binom_VS_robust_se",   "SL_VS_se",  "SL_rpart_VS_se",
  "SL_ranger_VS_se",      "SL_nnet_VS_se",

  # ── Precision-gain factors ──────────────────────────────────────────────
  ...
  "How much precision gain can SL_ranger_VS provide?",
  ...
  # ── Point estimates ─────────────────────────────────────────────────────
  "Unadjust_est",
  "ANCOVA_est",  "ANHECOVA_est",  "Binom_est",
  "SL_est",      "SL_rpart_est",  "SL_ranger_est",  "SL_nnet_est",
  "ANCOVA_VS_est",  "ANHECOVA_VS_est",  "Binom_VS_est",
  "SL_VS_est",      "SL_rpart_VS_est",  "SL_ranger_VS_est",
  "SL_nnet_VS_est",

  # ── Standardised differences in point estimates ────────────────────────
  ...
  "The difference between unadjusted and SL_ranger_VS point estimates",
  "The difference between unadjusted and SL_nnet_VS point estimates"
)

# Create a 1-row data frame with those as column names
df = as.data.frame(matrix(nrow = 1, ncol = length(col_names)))
