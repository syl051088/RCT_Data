...
```{r}
vars_to_count = c(
  "X_surgery_0d", "X_arne_score_0d", "X_known_DI_0d", "X_pathology_0d",
  "X_fs_0d", "X_oblm_0d", "X_dtm_0d", "X_spine_0d",
  "X_mallampati_0d", "X_relaxant_dose_0d"
)

library(dplyr)

count_tables = lapply(vars_to_count, function(var) {
  df10 %>%
...
final_count_table = bind_rows(count_tables) %>%
