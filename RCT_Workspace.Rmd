...
update_df = function(trial_no,
  ...
  if (suffix == "") {
    ...
    results_renamed = results %>%
      mutate(
        !!paste0("ANCOVA", suffix_clean, "_est")            := Est_RC_ANCOVA,
        !!paste0("ANCOVA", suffix_clean, "_robust_se")      := SE_RC_ANCOVA,
        !!paste0("ANHECOVA", suffix_clean, "_est")          := Est_RC_ANHECOVA,
        !!paste0("ANHECOVA", suffix_clean, "_robust_se")    := SE_RC_ANHECOVA,
        !!paste0("Binom", suffix_clean, "_est")             := Est_RC_Binom,
        !!paste0("Binom", suffix_clean, "_robust_se")       := SE_RC_Binom,
        !!paste0("ANCOVA", suffix_clean, "_model_based_se") := SE_AC,
        !!paste0("SL", suffix_clean, "_est")                := Est_SL,
        !!paste0("SL", suffix_clean, "_se")                 := SE_SL,
        Unadjust_est                                        := Est_UN,
        Unadjust_se                                         := SE_UN
      )
  }
  ...
  if (suffix == "") {
    ...
    sl_se_col = paste0("SL", suffix_clean, "_se")
    ...
    sl_est_col = paste0("SL", suffix_clean, "_est")
    ...
    results_processed = results_processed %>%
      mutate(
        ...
        !!paste0("How much precision gain can SL", suffix_clean, " provide?") := 
        ...
        !!paste0("The difference between unadjusted and SL", suffix_clean, " point estimates") := 
  ...
  for (m in sl_members) {
    if (suffix == "") {
      ...
      se_col  = paste0(m, "_", suffix, "_se")
      est_col = paste0(m, "_", suffix, "_est")
      pg_col  = paste0("How much precision gain can ", m, "_", suffix, " provide?")
      df_col  = paste0("The difference between unadjusted and ", m, "_", suffix, " point estimates")
    }
  ...
  ## ────────────────────────────────────────────────────────────────
  ## 2)  Add Selected_Covariates if it exists in results
  ## ────────────────────────────────────────────────────────────────
