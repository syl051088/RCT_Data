...
df2_final = df2 %>%
  ...
  mutate(
        ...
        across(c(X_sex_0d, X_fever_0d, X_cough_0d, X_respdiff_0d, X_comorb_0d, 
                 X_diabetes_0d, X_hyperten_0d), as_factor)
    ) %>% 
...
df7_final = df7 %>%
  ...
  mutate(
    ...
    across(c(X_variant_0d, X_IgG_0d, X_vaccine_status_0d, X_BMI_cat_0d, 
             ...
             X_bpco_0d, X_liver_0d), as_factor)
  ) %>% 
  select(
    Treatment,
    starts_with("YP_"),
...
df21_final = df21%>%
    ...
    X_cxr_done_0d                        = cxr_done,
    X_cad4tbv5_score_0d                  = cad4t_bv5_score,
    X_cad4tbv5_above_threshold_0d        = cad4t_bv5_above_threshold,
    X_sputum_xpert_done_0d               = sputum_xpert_done,
    X_sputum_xpert_result_0d             = sputum_xpert_result,
  ...
  mutate(
    ...
    across(c(YP_tb_treatment_initiation, YS_undiagnosed_tb, YS_same_day_tb_treatment, 
             ...
             X_fever_0d, X_reported_hiv_status_0d, X_cad4tbv5_above_threshold_0d, X_sputum_xpert_done_0d), as_factor)
  ) %>% 
  select(
    Treatment,
    starts_with("YP_"),
...
df28_final = df28 %>%
  ...
  mutate(
    ...
    across(c(YP_ContrSBP_6m, YS_ContrDBP_6m, YS_ControlledBP_6m, X_SEX_0m, X_Age_0m, 
             X_RxHTN_0m, X_ContrSBP_0m, X_ContrDBP_0m, X_ControlledBP_0m))
  ) %>%
  select(
    Treatment,
    starts_with("YP"),
...
df30_final = df30_demo %>%
  ...
  mutate(
    ...
    across(c(YP_Adherence, X_Sex_0d, X_Psychotropics_0d, X_Age_0d), as_factor)
  ) %>% 
