...
## Load Data
```{r}
df36 = read_xlsx("raw_data/36/36.xlsx")
```
...
```{r}
# trial 36
write_csv(df36_final, "cleaned_data/trial36.csv")
write_rds(df36_final, "cleaned_data/trial36.rds")
```
...
```{r}
# trial 37
write_csv(df37_final, "cleaned_data/trial37.csv")
write_rds(df37_final, "cleaned_data/trial37.rds")
```
...
```{r}
# trial 38
write_csv(df38_final, "cleaned_data/trial38.csv")
write_rds(df38_final, "cleaned_data/trial38.rds")
```
...
```{r}
# trial 39
write_csv(df39_final, "cleaned_data/trial39.csv")
write_rds(df39_final, "cleaned_data/trial39.rds")
```
...
```{r}
# trial 40
write_csv(df40_final, "cleaned_data/trial40.csv")
write_rds(df40_final, "cleaned_data/trial40.rds")
```
...
```{r}
# trial 41
write_csv(df41_final, "cleaned_data/trial41.csv")
write_rds(df41_final, "cleaned_data/trial41.rds")
```
...
```{r}
# trial 42
write_csv(df42_final, "cleaned_data/trial42.csv")
write_rds(df42_final, "cleaned_data/trial42.rds")
```
...
```{r}
# trial 43
write_csv(df43_final, "cleaned_data/trial43.csv")
write_rds(df43_final, "cleaned_data/trial43.rds")
```
...
## Load Data
```{r}
df44 = read_xlsx("raw_data/44/44.xlsx")
```
...
```{r}
# trial 44
write_csv(df44_final, "cleaned_data/trial44.csv")
write_rds(df44_final, "cleaned_data/trial44.rds")
```
...
## Load Data
```{r}
df45 = read_csv("raw_data/45/45.csv")
```
...
```{r}
# trial 45
write_csv(df45_final, "cleaned_data/trial45.csv")
write_rds(df45_final, "cleaned_data/trial45.rds")
```


```{r}
write_csv(df46, "raw_data/46/46_2.csv")
```

# Trial 46
## Load Data
```{r}
df46 = read_csv2("raw_data/46/46.csv")
```
...
```{r}
# trial 46
write_csv(df46_final, "cleaned_data/trial46.csv")
write_rds(df46_final, "cleaned_data/trial46.rds")
```
...
## Load Data
```{r}
df47 = read_xlsx("raw_data/47/47.xlsx", na = c("", ".", "NULL", "null", "md", "nc", "pf", "protocol finalized"))
```
...
```{r}
# trial 47
write_csv(df47_final, "cleaned_data/trial47.csv")
write_rds(df47_final, "cleaned_data/trial47.rds")
```
...
## Load Data
```{r}
df49 = read_csv2("raw_data/49/49_old.csv",  locale = locale(encoding = "Latin1"))
```
...
```{r}
# trial 49
write_csv(df49_final, "cleaned_data/trial49.csv")
write_rds(df49_final, "cleaned_data/trial49.rds")
```
